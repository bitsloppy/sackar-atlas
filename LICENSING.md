...
This repository contains three distinct types of content, each with its own licence.

| Folder | Content type | Licence |
|--------|-------------|---------|
| `site/` | Astro site code | [MIT](LICENSE-code) |
| `scripts/` | Data ingestion + build tools | [MIT](LICENSE-code) |
| `data/` | Structured historical data | [CC-BY 4.0](LICENSE-data) |
| `journalism/` | Original writing by Anna Roberts | [© All Rights Reserved](LICENSE-journalism) |

---

## Code — MIT

Everything in `site/` and `scripts/` is MIT-licensed.

Use it, modify it, build with it. No restrictions. If you build something with this code, you don't have to open-source it — but a mention is always appreciated.

→ [Full MIT licence text](LICENSE-code)

---

## Data — Creative Commons Attribution 4.0 (CC-BY 4.0)

Everything in `data/` is published under CC-BY 4.0.
...
Everything in `journalism/` is copyright © Anna Roberts. All rights reserved.
